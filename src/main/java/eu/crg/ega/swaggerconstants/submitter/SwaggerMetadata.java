...
public class SwaggerMetadata {
  ...
  public static final String LIST_USER_EXPERIMENTS_NOTES = "List all experiments uploaded by the user logged in.";
  public static final String LIST_USER_EXPERIMENTS = "List experiments";
  
  public static final String LIST_EXPERIMENTS_NOTES = "List all experiments related to this submission.";
  public static final String LIST_EXPERIMENTS = "List submission experiments";
  
  public static final String EXPERIMENTS = "Submit a new experiment";
  public static final String EXPERIMENTS_NOTES = "";

  public static final String LIST_USER_STUDIES_NOTES = "List all studies uploaded by the user logged in.";
  public static final String LIST_USER_STUDIES = "List studies";
  ...
  public static final String LIST_USER_DACS = "List DACs";
  public static final String LIST_USER_DACS_NOTES = "List all DACs uploaded by the user logged in.";
