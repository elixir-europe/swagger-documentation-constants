...
public class SwaggerAnalysisMetadata {

  public static final String DESCRIPTION = "Operations over analysis metadata";
  ...
  public static final String LIST_NOTES = "List all analysiss related to this submission.";
  public static final String LIST = "List submission analysiss";

  public static final String DELETE_NOTES = "Delete an analysis that is not used in any policy.";
  public static final String DELETE = "Delete an analysis";

  public static final String GET = "View analysis";
